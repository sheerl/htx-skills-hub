...
window.HTX_SKILLS = [
  // ===== Spot =====
  {
    ...
    install: 'npx -y github:sheerl/htx-skills-hub skill install spot-market', pkg: '@htx-skills/spot-market',
    tags: ['行情', 'K线', '现货', '免鉴权'],
  },
  {
    ...
    install: 'npx -y github:sheerl/htx-skills-hub skill install spot-account', pkg: '@htx-skills/spot-account',
    tags: ['账户', '划转', '鉴权'],
  },
  {
    ...
    install: 'npx -y github:sheerl/htx-skills-hub skill install spot-trading', pkg: '@htx-skills/spot-trading',
    tags: ['下单', '高风险', '鉴权'],
  },
  ...
  // ===== Futures =====
  {
    ...
    install: 'npx -y github:sheerl/htx-skills-hub skill install futures-market', pkg: '@htx-skills/futures-market',
    tags: ['永续', 'K线', '行情'],
  },
  {
    ...
    install: 'npx -y github:sheerl/htx-skills-hub skill install funding-rate', pkg: '@htx-skills/funding-rate',
    tags: ['资金费率', '永续', '套利'],
  },
  {
    ...
    install: 'npx -y github:sheerl/htx-skills-hub skill install oi-tracker', pkg: '@htx-skills/oi-tracker',
    tags: ['OI', '持仓量', '趋势'],
  },
  {
    ...
    install: 'npx -y github:sheerl/htx-skills-hub skill install elite-positioning', pkg: '@htx-skills/elite-positioning',
    tags: ['多空比', '聪明钱', '情绪'],
  },
  {
    ...
    install: 'npx -y github:sheerl/htx-skills-hub skill install liquidation-stream', pkg: '@htx-skills/liquidation-stream',
    tags: ['清算', '挤仓', '风险'],
  },
  {
    ...
    install: 'npx -y github:sheerl/htx-skills-hub skill install mark-price', pkg: '@htx-skills/mark-price',
    tags: ['标记价', '基差', '套利'],
  },
  {
    ...
    install: 'npx -y github:sheerl/htx-skills-hub skill install settlement', pkg: '@htx-skills/settlement',
    tags: ['结算', '保险基金', '风险'],
  },
  {
    ...
    install: 'npx -y github:sheerl/htx-skills-hub skill install futures-account', pkg: '@htx-skills/futures-account',
    tags: ['账户', '持仓', '杠杆'],
  },
  {
    ...
    install: 'npx -y github:sheerl/htx-skills-hub skill install futures-trading', pkg: '@htx-skills/futures-trading',
    tags: ['合约下单', '止盈止损', '高风险'],
  },
  ...
  // ===== Analyst =====
  {
    ...
    install: 'npx -y github:sheerl/htx-skills-hub skill install technical-analysis', pkg: '@htx-skills/technical-analysis',
  ...
  },
  {
    ...
    install: 'npx -y github:sheerl/htx-skills-hub skill install ta-master', pkg: '@htx-skills/ta-master',
    tags: ['综合评分', '三支柱', 'AI 分析'],
  },
  {
    ...
    install: 'npx -y github:sheerl/htx-skills-hub skill install derivatives-analyst', pkg: '@htx-skills/derivatives-analyst',
    tags: ['衍生品', '挤仓', 'AI 分析'],
  },
  {
    ...
    install: 'npx -y github:sheerl/htx-skills-hub skill install sentiment-analyst', pkg: '@htx-skills/sentiment-analyst',
    tags: ['情绪', '恐惧贪婪', 'AI 分析'],
  },
  {
    ...
    install: 'npx -y github:sheerl/htx-skills-hub skill install market-overview', pkg: '@htx-skills/market-overview',
    tags: ['行情总览', '板块', 'AI 分析'],
  },
];
